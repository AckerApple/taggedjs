...
export function subscriptionsSection() {
  return section.class`section-card`.id`subscriptions`(docH2("subscriptions", "📡 Subscriptions & Observables"), p(
    ...
    ), docH3("subscribe-output", "🧾 Output Subscriptions"), p(
      "Start by using ",
      code("subscribe(observable)"),
      " to display the latest value from an observable."
    ), docH3("subscribe-map", "🧩 Map Values to Output"), p(
    ...
    ), docH3("subscribe-no-arrow", "🚫 No _=> Wrapper"), p(
      "Do not wrap ",
      code("subscribe(...)"),
      " with ",
      code("_=>"),
    ...
    ), docH3("subscribe-combine", "🔗 Combine Observables"), p(
    ...
    ), docH3("subscribe-with-default", "Default value with subscribeWith"), p(
      "Use ",
      code("subscribeWith"),
    ...
    ), docH3("subscribe-attributes", "🎨 Subscriptions in Attributes"), p(
    ...
    ), docH3("subscription-lifecycle", "♻️ Subscription Lifecycle"), p(
      "When a ",
      code("subscribe"),
      ...
      code("unsubscribe"),
      "."
    ), docH3("manual-unsubscribe", "🧹 Manual Unsubscribe"), p(
