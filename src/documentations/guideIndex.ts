...
const tocItems = [
  ...
  { id: "tag-component-arguments", label: "🧵 Component Arguments" },
  { id: "tag-component-inputs-updates", label: "🔌 Inputs and Updates", level: "sub" },
  ...
  { id: "static-html-seo-output", label: "🔎 Static HTML / SEO Output", level: "sub" },
