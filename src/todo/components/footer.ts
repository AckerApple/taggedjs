...
export const Footer = (
  ...
  return footer.class`footer`.attr("data-testid", "footer")(span.class`todo-count`(_=> activeTodoCount, ' item', _=> activeTodoCount > 1 && "s", ' left!'), ul.class`filters`(li(
        a.id`todo-view-all-link`.class(_=> route === "/" ? "selected" : "").href`#/`('All')
      ), li(
