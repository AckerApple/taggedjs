...
export const subscribeAttributes = tag(() => {
  ...
  const attributeContent =  () => {
    ...
    return div.style`display:flex;flex-wrap:wrap;gap:1em;font-size:0.8em`.id`subscribe-attributes-wrap`(
      div.style`display:flex;flex-wrap:wrap;gap:1em`(
        fieldset.style`flex-grow:1`(
          ...
          span
            ...
            .style(
              subscribeWith(subColor$, 'red', (subColor) => {
        ...
        fieldset.style`flex-grow:1`(
          ...
          span.id`multiple-subscribe-bg-color`.style(() => {
              return (
                subColor$.value === 'blue' &&
  ...
  return fieldset.style`flex-grow:1`(
    ...
    button.id`toggle-attributes-btn`.type`button`.onClick(() => {
    ...
    button.onClick(() => subColor$.next('')).id`clear-color-btn`.type`button`(`Clear Color`),
