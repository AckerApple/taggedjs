      ...
      div
        ...
        (
          ...
          div.style("border:1px solid blue;flex-grow:1")(
            ...
            div(() => {
              switch (selectedTag) {
                case null: return div.id("select-tag-above")('null, select tag above')
                case "": return div.id("select-tag-above")('empty-string, select tag above')
...
export const tag1 = tag(({title}: {title: string}) => {
  ...
  return div
    ...
    .style("border:1px solid orange;")(
      div.id("tagSwitch-1-hello")(() => `Hello 1 ${title} World`),
