...
export type ElementFunction = ((attributesOrFirstChild: TagChildContent | Attributes, ...children: TagChildContent[]) => ElementFunction & CombinedElementFunctions) & CombinedElementFunctions;
export {};
