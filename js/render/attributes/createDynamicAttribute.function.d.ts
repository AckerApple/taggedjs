...
support: AnySupport, counts: TagCounts, values: unknown[], varNumber: number): void;
...
support: AnySupport, counts: TagCounts, isSpecial: SpecialDefinition, varIndex: number): void;
