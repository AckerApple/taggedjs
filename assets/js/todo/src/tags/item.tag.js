...
export const Item = tag((todo, dispatch, index) => {
    ...
    let editing = false;
    return li["class.completed"](_ => todo.completed)["class.editing"](_ => editing)(_ => !editing ?
        ...
        :
            ...
            }), label({ class: "visually-hidden", htmlFor: "todo-input" }, 'Edit Todo Input')))(e.key === "Enter");
    {
