...
export const homePage = () => tag.use = (showSections = true, appCounter = 0, toggleValue = false, testTimeout = null, appCounterSubject = state(() => new Subject(appCounter)), renderCount = 0, testEmoji = '🟦', _ = states(get => [{
        showSections,
        appCounter,
        toggleValue,
        testTimeout,
