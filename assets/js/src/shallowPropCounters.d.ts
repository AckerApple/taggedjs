export declare const shallowPropCounters: import("taggedjs").TaggedFunction<({ propCounter, increasePropCounter, }: {
    propCounter: number;
    increasePropCounter: () => void;
}) => ((...children: import("taggedjs").TagChildContent[]) => import("taggedjs").ElementFunction & import("taggedjs").CombinedElementFunctions) & import("taggedjs/js/TagJsTags/TagJsTag.type").ReadOnlyVar & {
    tagName: string;
    innerHTML: any[];
