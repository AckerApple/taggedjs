...
export declare const autoTestingControls: import("taggedjs").TaggedFunction<(tests?: ViewTypes[], runStartEndTests?: boolean) => ((...children: import("taggedjs").TagChildContent[]) => import("taggedjs").ElementFunction & import("taggedjs").CombinedElementFunctions) & import("taggedjs/js/TagJsTags/TagJsTag.type").ReadOnlyVar & {
    tagName: string;
    innerHTML: any[];
