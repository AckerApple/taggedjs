...
export const GuideApp = tag(() => [
    guideHeader(),
    main(a.id `top`(), div.class `guide-layout`(guideIndex(), div({ class: "guide-content" }, projectLayoutSection(), entryPointSection(), componentPatternSection(), displaySection(), reactiveUpdatesSection(), subscriptionsSection())).getElementById("docs-app"))
]);
if (!mount) {
    return;
}
