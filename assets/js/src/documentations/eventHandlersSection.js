...
export function eventHandlersSection() {
    return [
        ...
        p("Event handlers use method chaining like ", code("button.onClick(...)"), ". The code in ", code("src/basic.tag.ts"), " shows the standard pattern."),
        figure(pre(code.class `language-ts`(eventHandlersCode)), figcaption("Source: ", a.href(`${repoBaseUrl}/src/basic.tag.ts`).target `_blank`(code("src/basic.tag.ts")))),
    ];
}
//# sourceMappingURL=eventHandlersSection.js.map