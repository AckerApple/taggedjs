export declare const App: import("taggedjs").TaggedFunction<import("taggedjs").TaggedFunction<() => (menuName?: string) => ((((...children: import("taggedjs").TagChildContent[]) => import("taggedjs").ElementFunction & import("taggedjs").CombinedElementFunctions) & import("taggedjs/js/TagJsTags/TagJsTag.type").ReadOnlyVar & {
    tagName: string;
    innerHTML: any[];
...
}) | import("taggedjs").SubscribeValue | (() => any))[]>>;
