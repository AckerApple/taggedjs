import { CombinedElementFunctions } from "taggedjs";
import { OnHeaderClick } from "./index";
import { EverySimpleValue } from "./dump.props";
export declare const dumpSimple: import("taggedjs").TaggedFunction<({ key, value, onHeaderClick, everySimpleValue }: {
    key: string | undefined;
    value: any;
    onHeaderClick?: OnHeaderClick;
    everySimpleValue?: EverySimpleValue;
}) => ((...children: import("taggedjs").TagChildContent[]) => import("taggedjs").ElementFunction & CombinedElementFunctions) & import("taggedjs/js/TagJsTags/TagJsTag.type").ReadOnlyVar & {
    tagName: string;
    innerHTML: any[];
