...
export const controlPanel = tag(({ value, format, showAll, formatChange, showAllChange, }) => {
    ...
    `), div.style `width: 100%;line-height: 90%;`(div.style `position:relative`(div.style `display:flex;font-size:50%;position:absolute;top:-18px;right:-6px`(_ => (!format || format === 'flex') && a({
