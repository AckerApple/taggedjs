...
describe('👶 👧child tests', () => {
    ...
    it('b', () => {
        testDuelCounterElements(['#childTests-button', '#childTests-display'], ['#child-as-prop-test-button', '#child-as-prop-test-display']);
        testCounterElements('#innerHtmlPropsTest-childTests-button', '#innerHtmlPropsTest-childTests-display');
    });
    it('c', () => {
        testDuelCounterElements(['#childTests-button', '#childTests-display'], ['#innerHtmlTest-childTests-button-c', '#innerHtmlTest-childTests-display-c']);
    });
});
