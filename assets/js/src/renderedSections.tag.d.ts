...
export declare const renderedSections: import("taggedjs").TaggedFunction<(appCounterSubject: Subject<number>, viewTypes?: ViewTypes[]) => ((...children: import("taggedjs").TagChildContent[]) => import("taggedjs").ElementFunction & import("taggedjs").CombinedElementFunctions) & import("taggedjs/js/TagJsTags/TagJsTag.type").ReadOnlyVar & {
    tagName: string;
    innerHTML: any[];
