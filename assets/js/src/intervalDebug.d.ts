export declare const intervalTester0: import("taggedjs").TaggedFunction<() => ((...children: import("taggedjs").TagChildContent[]) => import("taggedjs").ElementFunction & import("taggedjs").CombinedElementFunctions) & import("taggedjs/js/TagJsTags/TagJsTag.type").ReadOnlyVar & {
    tagName: string;
    innerHTML: any[];
...
export declare const intervalTester1: import("taggedjs").TaggedFunction<() => ((...children: import("taggedjs").TagChildContent[]) => import("taggedjs").ElementFunction & import("taggedjs").CombinedElementFunctions) & import("taggedjs/js/TagJsTags/TagJsTag.type").ReadOnlyVar & {
    tagName: string;
    innerHTML: any[];
    attributes: import("taggedjs/js/interpolations/optimizers/ObjectNode.types").Attribute[];
    contentId: number;
